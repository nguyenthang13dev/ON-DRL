...
const LinkedAccountsDashboard: React.FC<LinkedAccountsDashboardProps> = ({
    ...
    const handleUnlinkAccount = useCallback(
        async (chatId: string, fullName?: string) => {
            try {
                setLoading(true);
                const response = await userTelegramService.unlinkByChatIds([
                    chatId,
                ]);
                ...
                if (response.status) {
                    ...
                    toast.error(
                        response.message || "Có lỗi xảy ra khi gỡ liên kết",
                    );
                }
            } catch (error: any) {
        ...
        },
        {
            ...
            render: (_, record) => (
                <Popconfirm
                    ...
                    onConfirm={() =>
                        handleUnlinkAccount(record.chatId, record.fullName)
                    }
                    okText="Có"
                    cancelText="Không"
            ...
            title={
                <div className="flex items-center justify-between">
                    <div className="flex items-center">
                        ...
                        <Title level={5} className="mb-0 text-[#7c3aed]">
                    ...
                    <Space>
                        <Button
                            ...
                            loading={refreshing}
                            className="text-gray-500 hover:text-[#7c3aed] hover:bg-purple-50"
                        >
                            Làm mới
                        </Button>
                        {onLinkNew && (
                        ...
                        description={
                            <div className="text-center">
                                ...
                                <Text className="text-sm text-gray-400">
                                    Liên kết tài khoản Telegram để nhận thông
                                    báo từ hệ thống
                                </Text>
                            </div>
                        }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-4">
                            <div className="flex items-center justify-between">
                                ...
                                <UserOutlined className="text-2xl text-[#7c3aed]" />
                            </div>
                        </div>
