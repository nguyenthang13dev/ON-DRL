...
const TelegramLinkingInterface: React.FC<TelegramLinkingInterfaceProps> = ({
    ...
    const handleGenerateToken = useCallback(async () => {
        ...
        try {
            const response =
                await userTelegramService.generateTelegramLinkToken();
            ...
            if (response.status && response.data) {
                ...
                throw new Error(
                    response.message || "Không thể tạo mã xác thực",
                );
            }
        } catch (error: any) {
    ...
    const startPolling = useCallback(() => {
        ...
        const intervalId = setInterval(async () => {
            try {
                const response = await userTelegramService.checkLinked(
                    token.token,
                );
                const data = response.data as any;
                ...
                if (response.status && isLinked) {
                    ...
                    const accountsResponse =
                        await userTelegramService.getAllLinked();
                    if (
                        ...
                        const latestAccount =
                            accountsResponse.data[
                                accountsResponse.data.length - 1
                            ];
            ...
            <div className="mb-8">
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <Title level={3} className="mb-2 text-[#7c3aed]">
                                <SendOutlined className="mr-3 text-[#0088cc]" />
                                Liên kết tài khoản Telegram
                            </Title>
                            <Text className="text-gray-600">
                                Kết nối với Telegram để nhận thông báo từ hệ
                                thống
                            </Text>
                        </div>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1">
                    <Card className="border-0 shadow-md">
                        <Title level={5} className="mb-4 text-[#7c3aed]">
                            Tiến trình liên kết
                        </Title>
                        <Steps
                            direction="vertical"
                            ...
                            <div className="text-center py-12">
                                <div className="mb-6">
                                    <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                                        <SafetyCertificateOutlined className="text-2xl text-[#7c3aed]" />
                                    </div>
                                    <Title level={4} className="mb-2">
                                        Bắt đầu liên kết
                                    </Title>
                                    <Text className="text-gray-600">
                                        Tạo mã xác thực để kết nối với bot
                                        Telegram
                                    </Text>
                                </div>
                                ...
                                <Button
                                    ...
                                    className="bg-[#7c3aed] hover:bg-purple-600 border-0 px-8 py-2 h-auto"
                        ...
                        {currentStep === 1 && token && (
                            <div className="py-8">
                                <div className="text-center mb-8">
                                    ...
                                    <Text className="text-gray-600">
                                        Sao chép mã và mở Telegram để hoàn tất
                                        liên kết
                                    </Text>
                                </div>
                                ...
                                <div className="bg-gray-50 rounded-lg p-6 mb-6">
                                    <div className="flex items-center justify-between mb-4">
                                        <Text strong className="text-[#7c3aed]">
                                            Mã xác thực của bạn:
                                        </Text>
                                        <Button
                                            type="link"
                                    ...
                                    <div className="bg-white border-2 border-dashed border-gray-300 rounded-lg p-4 mb-4">
                                        <div className="flex flex-col gap-3">
                                            <div className="max-w-full overflow-hidden">
                                                <code className="text-sm font-mono text-[#7c3aed] font-bold break-all leading-relaxed block bg-purple-50 p-3 rounded border">
                                                    {token.token}
                                                </code>
                                            </div>
                                ...
                                <div className="bg-blue-50 rounded-lg p-4">
                                    <Text
                                        strong
                                        className="text-[#7c3aed] block mb-2"
                                    >
                                        Hướng dẫn thủ công:
                                    </Text>
                                    <ol className="text-sm text-gray-700 space-y-1 pl-4">
                                        <li>
                                            1. Mở ứng dụng Telegram trên điện
                                            thoại/máy tính
                                        </li>
                                        <li>
                                            2. Tìm kiếm bot:{" "}
                                        ...
                                        <li>
                                            3. Nhấn <strong>/start</strong> và
                                            dán mã xác thực
                                        </li>
                                        <li>
                                            4. Chờ hệ thống xác nhận kết nối
                                        </li>
                                    </ol>
                                </div>
                            </div>
                        ...
                        {currentStep === 3 && (
                            <div className="text-center py-12">
                                <div className="mb-6">
                                    ...
                                    <Text className="text-gray-600">
                                        Tài khoản Telegram đã được liên kết với
                                        hệ thống
                                    </Text>
                                </div>
                                ...
                                <Button
                                    type="primary"
                                    onClick={onBack}
                                    className="bg-[#7c3aed] hover:bg-purple-600 border-0"
                                >
                                    Hoàn tất
                                </Button>
                            </div>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <div className="bg-gray-100 p-3 rounded mt-2">
                            <code className="text-sm font-mono text-[#7c3aed] break-all leading-relaxed block">
                                {token?.token}
                            </code>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ol className="mt-2 space-y-2">
                            <li>
                                1. Mở Telegram và tìm kiếm{" "}
                                <code>@HiNET_Service_bot</code>
                            </li>
