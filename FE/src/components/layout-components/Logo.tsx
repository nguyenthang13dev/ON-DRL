  ...
  return (
    <LogoWrapper className={isMobile && !mobileLogo ? "d-none" : "logo"}>
      <Link href="/dashboard" className="flex items-center shrink-0">
        <Image src={getLogo()} alt={`${APP_NAME} logo`} preview={false} />
        <div
          style={{ lineHeight: "28px", fontSize: "20px" }}
          className="font-bold uppercase text-black leading-4.5 center w-[250px] text-lg text-center font-sans tracking-tight"
        >
          HINET- EMS <br />
          Trust to success
        </div>
