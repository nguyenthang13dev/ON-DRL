...
import NS_HopDongLaoDongDetail from "./detail";
...
import NS_HopDongLaoDongCreateOrUpdate from "./createOrUpdate";
import dayjs from "dayjs";

const NS_HopDongLaoDongPage: React.FC = () => {
  ...
  const [currentItem, setCurentItem] = useState<NS_HopDongLaoDongType | null>(
    null
  );
  ...
  const onFinishSearch: FormProps<NS_HopDongLaoDongSearchType>["onFinish"] =
    async (values) => {
      try {
  ...
  const handleLoadData = useCallback(
    async (searchDataOverride?: NS_HopDongLaoDongSearchType) => {
      ...
      const response = await nS_HopDongLaoDongService.getData(searchData);
    ...
    <>
      ...
      >
        ...
        <div className="btn-group">
          ...
          {isOpenModal && (
            <NS_HopDongLaoDongCreateOrUpdate
...
export default withAuthorization(NS_HopDongLaoDongPage, "");
