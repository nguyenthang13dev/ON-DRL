...
export default function RootLayout({
  ...
  return (
    <ConfigProvider locale={locale} theme={themConfig}>
      <Layout style={{ overflowX: 'hidden' }}> {/* Thêm overflowX: hidden */}
        <ToastContainer />
        <HeaderPublic />
        <Layout style={getLayoutDirectionGutter()}>
          ...
          {pathname !== '/auth/login' && pathname !== '/auth/register' && (
            <div className="flex flex-col md:flex-row items-center gap-2 md:gap-6 justify-center p-1 text-center">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex flex-col md:flex-row gap-1 md:gap-6 p-1 justify-center">
